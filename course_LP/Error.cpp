...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(605,"Ошибка массив может содержать только литералы"),
		ERROR_ENTRY(606,"Ошибка размер массив дожен указываться только литералом или константой"),
		ERROR_ENTRY(607,"Ошибка массив записан не в верном фрмате"),
